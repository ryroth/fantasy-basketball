...
A starter web app created with [Vite](https://vite.dev/) — Ryan's first real project in Cursor, connected to GitHub.
...
```bash
gh repo create fantasy-basketball --public --source=. --remote=origin --push
```
